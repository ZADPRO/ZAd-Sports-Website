...
import AdminRelease from "../Release/NewRelease";
import Blogs from "../Blogs/blogs";
import Achievements from "../04-Achievements/Achievements";
import ListUserReview from "../UserFeedback/UserFeedBack";
import FeedBackForm from "../07-FeedBackForm/FeedBackForm";
// import Blogs from "../Blogs/blogs";
...
const Home: React.FC = () => {
  ...
  //         content:
  //           "Users can now experience a faster and cleaner interface for ground booking with fewer steps.",
  //       },
  //       {
  //         title: "Slot Availability Fix",
  //         content:
  //           "Resolved issues where slots weren't showing up in rare time zones.",
  //       },
  //     ],
  //   },
  //   {
  ...
  //         content:
  //           "Dashboard now shows insights like revenue, bookings per day, and reviews.",
  //       },
  //       {
  //         title: "Search Filters Added",
  //         content:
  //           "Users can filter grounds by sport type, lighting, amenities, and more.",
  //       },
  //     ],
  //   },
  //   {
  ...
  //         title: "Bug Fixes",
  //         content:
  //           "Minor performance improvements and fixes from 2.0 feedback.",
  //       },
  //     ],
  //   },
  //   {
  ...
  //         content:
  //           "ZadSports is now available on Android and iOS for faster access.",
  //       },
  //       {
  ...
  //         content:
  //           "Users and owners can now chat directly with our team inside the app.",
  //       },
  //     ],
  //   },
  // ];
  ...
  // const versionTemplate = (item: any) => {
            ...
            {[
              {
                ...
                description:
                  "Expanding rapidly with verified sports venues across regions.",
              },
              {
                title: "1000+ Seamless Bookings",
                description:
                  "Real-time slot bookings completed smoothly through the platform.",
              },
              {
                title: "Owners & Players Portals",
                description:
                  "Dedicated interfaces for ground owners and sports players.",
              },
              {
                title: "100% Verified Listings",
                description:
                  "All grounds are checked and approved by our admins.",
              },
              {
                title: "Growing Community",
                description:
                  "Trusted by a vibrant community of sports enthusiasts and pros.",
              },
              {
                title: "Supportive Platform",
                description:
                  "Backed by responsive support and helpful tools for all users.",
              },
            ].map((service, index) => (
              <motion.div
                key={index}
